...
export const BoutiqueDashboard: React.FC = () => {
  ...
  const getFilteredProducts = () => {
    return safeProducts.filter(p => {
      const matchesSearch = p && p.title && (p.title.toLowerCase().includes(prodSearch.toLowerCase()) || p.category.toLowerCase().includes(prodSearch.toLowerCase()));
  ...
  const getFilteredNotifications = () => {
    return safeNotifications.filter(n => {
      const matchesSearch = n && n.title && (n.title.toLowerCase().includes(notifSearch.toLowerCase()) || n.message.toLowerCase().includes(notifSearch.toLowerCase()));
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-10 font-sans space-y-8">
      ...
      {/* Cover Banner Area */}
      {profile.bannerUrl ? (
        <div className="h-48 md:h-64 rounded-xl overflow-hidden relative shadow-md">
        ...
        <div className="bg-luxury-cream border border-neutral-200 rounded-xl p-8 flex items-center gap-6 relative shadow-sm">
          {profile.logoUrl && (
      ...
      {/* Main Tab Panels */}
      <div className="min-h-[50vh] bg-white border border-neutral-200 rounded-xl p-6 lg:p-8 shadow-sm">
        
        {/* OVERVIEW PANEL */}
        {activeTab === 'overview' && (
          <div className="space-y-8">
             <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div className="bg-[#FAF9F6] border border-neutral-200 rounded-xl p-5 space-y-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-[#FAF9F6] border border-neutral-200 rounded-lg p-2.5"
                />
              </div>
              <div className="space-y-1">
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center border-b pb-4">
              ...
              <button
                ...
                className="bg-luxury-dark hover:bg-luxury-gold text-white font-semibold text-xs uppercase tracking-wider px-4 py-2 rounded-lg flex items-center gap-1.5"
              >
            ...
            {/* Add Tailor Form */}
            {showTailorForm && (
              <form onSubmit={handleTailorSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-sans p-5 bg-[#FAF9F6] border border-neutral-200 rounded-xl">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-neutral-200 rounded-lg p-2.5"
                  />
                </div>
                <div className="space-y-1">
                  <ImageUpload
        ...
        {activeTab === 'portfolio' && (
          <div className="space-y-6">
            ...
            {/* Add Portfolio Form */}
            {showPortfolioForm && (
              <form onSubmit={handlePortfolioSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-sans p-5 bg-[#FAF9F6] border border-neutral-200 rounded-xl">
                <div className="space-y-1">
        ...
        {activeTab === 'inventory' && (
          <div className="space-y-6">
              ...
              <div className="flex gap-2 text-xs">
                <div className="relative">
                  <input
                    ...
                    className="border border-neutral-200 rounded-xl pl-8 pr-4 py-2 bg-[#FAF9F6]"
                  />
                ...
                <select
                  ...
                  className="border border-neutral-200 rounded-xl p-2 bg-[#FAF9F6]"
                >
            ...
            {showProductForm && (
              <form onSubmit={handleProductSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-sans p-5 bg-[#FAF9F6] border border-neutral-200 rounded-xl">
                <div className="space-y-1">
          ...
          <div className="space-y-6">
            ...
            {orders.length === 0 ? (
              ...
              <div className="space-y-4">
                {orders.map((o) => (
                  <div key={o.id} className="border border-neutral-200 rounded-xl p-5 bg-[#FAF9F6] space-y-4 text-xs font-sans">
                    <div className="flex flex-col sm:flex-row justify-between sm:items-center border-b border-neutral-100 pb-3 gap-2">
                      <div>
        ...
        {activeTab === 'hiring' && (
          <div className="space-y-6">
            ...
            {/* Add vacancy Form */}
            {showHiringForm && (
              <form onSubmit={handleHiringSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-sans p-5 bg-[#FAF9F6] border border-neutral-200 rounded-xl">
                <div className="space-y-1">
            ...
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 border-b pb-4">
              ...
              <div className="flex gap-2 text-xs">
                ...
                <button
                  ...
                  className="border border-neutral-200 hover:border-luxury-gold hover:text-luxury-gold rounded-xl px-4 py-2 font-semibold flex items-center gap-1.5"
                >
            ...
            {getFilteredNotifications().length === 0 ? (
              ...
              <div className="space-y-3">
                {getFilteredNotifications().map((n) => (
                  <div key={n.id} className={`border rounded-xl p-4 flex justify-between gap-4 text-xs font-sans transition-colors ${
                    n.read 
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="bg-[#FAF9F6] border border-zinc-200 px-2 py-0.5 rounded text-[8px] uppercase tracking-wider font-bold">
                          {n.type}
                        </span>
                      </div>
