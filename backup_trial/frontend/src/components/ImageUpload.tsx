...
const CLOUDINARY_CLOUD_NAME = 'nm8mndum';
const CLOUDINARY_UPLOAD_PRESET = 'clara_fashion_unsigned';
const CLOUDINARY_UPLOAD_URL = `https://api.cloudinary.com/v1_1/${CLOUDINARY_CLOUD_NAME}/image/upload`;
// Cloudinary delete requires server-side API secret — keep backend route for deletions
const API_DELETE_URL = '/api/upload';
// Max 50MB per file
...
export const ImageUpload: React.FC<ImageUploadProps> = ({
   ...
   */
  const uploadToCloudinary = (file: File): Promise<{ url: string; public_id: string }> => {
    return new Promise((resolve, reject) => {
      ...
      formData.append('folder', 'clara-fashion');
